...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC03_CDS_Filter_ExprStrtgies-RNASeq.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CDS/Filter/ExperimentalStrategies/ExperimentalStartegies_Ddn'),5)
...
WebUI.waitForElementPresent(findTestObject('CDS/Filter/ExperimentalStrategies/RNASeq-Chkbx'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('CDS/Filter/ExperimentalStrategies/RNASeq-Chkbx')
