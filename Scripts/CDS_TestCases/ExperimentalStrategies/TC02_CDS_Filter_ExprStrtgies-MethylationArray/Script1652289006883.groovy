...
//Clicking MethylationArray checkbox
WebUI.waitForElementPresent(findTestObject('CDS/Filter/ExperimentalStrategies/MethylationArray-Chkbx'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('CDS/Filter/ExperimentalStrategies/MethylationArray-Chkbx')
