...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC02_CDS_Filter_Study-B.xlsx')
...
//Clicking Study-B checkbox
WebUI.waitForElementPresent(findTestObject('CDS/Filter/Study/CDS-Study-B-Chkbx'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('CDS/Filter/Study/CDS-Study-B-Chkbx')
