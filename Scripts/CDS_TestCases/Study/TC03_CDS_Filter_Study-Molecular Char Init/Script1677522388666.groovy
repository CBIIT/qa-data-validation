...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC03_CDS_Filter_Study-Molecular Char Init.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/CDS/Filter/Study/Study_Ddn'),5)
...
WebUI.waitForElementPresent(findTestObject('CDS/Filter/Study/CDS-Study-Molecular Char Init-Chkbx'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('CDS/Filter/Study/CDS-Study-Molecular Char Init-Chkbx')
