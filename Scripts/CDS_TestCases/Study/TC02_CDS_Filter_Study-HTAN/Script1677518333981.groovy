...
WebUI.waitForElementPresent(findTestObject('CDS/Filter/Study/CDS-Study-HTAN-Chkbx'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('CDS/Filter/Study/CDS-Study-HTAN-Chkbx')
