...
WebUI.waitForElementPresent(findTestObject('CDS/Data_page/Filter/Tumor/Tumor_Ddn'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('CDS/Filter/Tumor/Tumor_Ddn')

//Clicking Normal checkbox
WebUI.waitForElementPresent(findTestObject('CDS/Data_page/Filter/Tumor/Tumor-Chkbx'),5)
