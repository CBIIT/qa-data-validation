...
WebUI.waitForElementPresent(findTestObject('CDS/Filter/Tumor/Tumor-Chkbx'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('CDS/Filter/Tumor/Tumor-Chkbx')
