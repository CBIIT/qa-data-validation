...
WebUI.waitForElementVisible(findTestObject('Bento/Filter/Diagnosis/DIAGNOSIS_Ddn'), 10)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Bento/Filter/MenopauseStatus/MenopauseStatus_Ddn'), 10)
