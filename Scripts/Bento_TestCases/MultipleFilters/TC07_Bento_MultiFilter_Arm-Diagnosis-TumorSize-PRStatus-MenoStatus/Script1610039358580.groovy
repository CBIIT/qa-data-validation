...
WebUI.waitForElementVisible(findTestObject('Bento/Cases_page/Filter/Diagnosis/DIAGNOSIS_Ddn'), 10)
...
WebUI.waitForElementClickable(findTestObject('Bento/Cases_page/Filter/MenopauseStatus/MenopauseStatus_Ddn'), 10)

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('Object Repository/Bento/Filter/MenopauseStatus/MenopauseStatus_Ddn')

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('Object Repository/Bento/Filter/MenopauseStatus/Pre_Chkbx')
