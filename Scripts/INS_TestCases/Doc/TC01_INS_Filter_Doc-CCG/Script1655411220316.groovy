...
WebUI.waitForElementPresent(findTestObject('Object Repository/INS/Navbar/INS_Project_Btn'), 5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('Object Repository/INS/Navbar/INS_Project_Btn')
