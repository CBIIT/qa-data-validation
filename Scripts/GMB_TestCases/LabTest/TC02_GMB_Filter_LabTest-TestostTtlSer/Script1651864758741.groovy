...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC02_GMB_Filter_LabTest-TestostTtlSer.xlsx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabGMBStat'('GMB/Filter/LabTest/LabTest_Ddn')

//Clicking (TestostTtlSer) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/LabTest/TestostTtlSer_Chkbx'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabGMBStat'('GMB/Filter/LabTest/TestostTtlSer_Chkbx')
