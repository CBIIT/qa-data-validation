...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC10_GMB_Filter_DiseaseStageAtEntry-IIIA.xlsx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabGMBStat'('GMB/Filter/DiseaseStageAtEntry/DiseaseStageAtEntry_Ddn')

//Clicking IIIA checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/DiseaseStageAtEntry/IIIA_Chkbx'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabGMBStat'('GMB/Filter/DiseaseStageAtEntry/IIIA_Chkbx')
