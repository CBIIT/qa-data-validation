...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC06_GMB_Filter_SourceOfLabData-Cincinchil.xlsx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabGMBStat'('GMB/Filter/SourceOfLabData/SourceOfLabData_Ddn')

//Clicking (Cincinchil) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SourceOfLabData/Cincinchil_Chkbx'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabGMBStat'('GMB/Filter/SourceOfLabData/Cincinchil_Chkbx')
