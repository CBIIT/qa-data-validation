...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC02_GMB_Filter_PatientSubgroup-Cohort2.xlsx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabGMBStat'('GMB/Filter/PatientSubgroup/PatientSubgroup_Ddn')

//Clicking (Cohort2) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/PatientSubgroup/Cohort2_Chkbx'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabGMBStat'('GMB/Filter/PatientSubgroup/Cohort2_Chkbx')
