...
WebUI.waitForElementPresent(findTestObject('CRDC/NavBar/JoinCrdcDataHub-Dd'), 3)

WebUI.click(findTestObject('CRDC/NavBar/JoinCrdcDataHub-Dd'))

WebUI.waitForElementPresent(findTestObject('CRDC/NavBar/CrdcSubmisnRequests-Link'), 3)

WebUI.click(findTestObject('CRDC/NavBar/CrdcSubmisnRequests-Link'))
