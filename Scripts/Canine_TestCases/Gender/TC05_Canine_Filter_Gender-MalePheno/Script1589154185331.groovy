...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC05_Canine_Filter_Gender-MalePheno.xlsx')
...
WebUI.click( findTestObject('Object Repository/Canine/Filter/Gender/MalePhenotype_Chkbx') )
