...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC38_Canine_Filter_Breed-Weimrnr.xlsx')
...
WebUI.click( findTestObject('Object Repository/Canine/Filter/Breed/Weimrnr_Chkbx')   )
