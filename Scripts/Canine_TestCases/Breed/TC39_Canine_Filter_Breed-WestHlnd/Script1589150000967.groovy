...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC39_Canine_Filter_Breed-WestHlnd.xlsx')
...
WebUI.click(  findTestObject('Object Repository/Canine/Filter/Breed/WestHland_Chkbx') )
