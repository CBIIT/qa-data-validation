...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC26_Canine_Filter_Breed-IrishSettr.xlsx')
...
WebUI.click( findTestObject('Object Repository/Canine/Filter/Breed/IrishSetter_Chkbx'))
