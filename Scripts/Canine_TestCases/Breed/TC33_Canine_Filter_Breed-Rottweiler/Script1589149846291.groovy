...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC33_Canine_Filter_Breed-Rottweiler.xlsx')
...
WebUI.click(  findTestObject('Object Repository/Canine/Filter/Breed/Rottweiler_Chkbx') )
