...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC22_Canine_Filter_Breed-Giant.xlsx')
...
WebUI.click( findTestObject('Object Repository/Canine/Filter/Breed/Giant_Chkbx') )
