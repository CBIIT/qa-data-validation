...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC37_Canine_Filter_Breed-Vizsla.xlsx')
...
WebUI.click( findTestObject('Object Repository/Canine/Filter/Breed/Vizsla_Chkbx') )
