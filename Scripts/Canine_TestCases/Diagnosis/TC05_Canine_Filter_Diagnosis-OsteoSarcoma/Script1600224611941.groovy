...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC10_Canine_Filter_Diagnosis-LymphGranulo.xlsx')
...
WebUI.click(findTestObject('Canine/Filter/Diagnosis/OsteoSarcoma_Chkbx'))
