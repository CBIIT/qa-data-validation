...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC13_Canine_Filter_Diagnosis-MaligSingle.xlsx')
...
WebUI.click(  findTestObject('Canine/Filter/Diagnosis/PulmonaryNeo_Chkbx')  )
