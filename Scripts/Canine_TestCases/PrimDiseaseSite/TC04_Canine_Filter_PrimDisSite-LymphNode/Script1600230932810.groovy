...
WebUI.click(findTestObject('Canine/Filter/PrimDiseaseSite/PRIMARYDISEASESITE_Ddn'))

WebUI.click(findTestObject('Canine/Filter/PrimDiseaseSite/LymphNode_Chkbx'))
