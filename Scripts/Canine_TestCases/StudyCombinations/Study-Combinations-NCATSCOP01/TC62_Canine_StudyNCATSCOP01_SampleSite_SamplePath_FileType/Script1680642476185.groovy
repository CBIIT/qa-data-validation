...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC62_Canine_StudyNCATSCOP01_SampleSite_SamplePath_FileType.xlsx')   //changed for NCATS
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/SampleSite/Sample Site_LungCaudalAspectofLeftCaudalLobe_Chkbx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/SamplePathology/PulmoCarcinoma_Chkbx')
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Object Repository/Canine/Filter/SamplePathology/SAMPLEPATHOLOGY_Ddn')
WebUI.delay(3)
...
//CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/FileType/SupplementalDataFile_Chkbx')
