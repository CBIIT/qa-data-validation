...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC36_Canine_StudyMGT-Breed_SampleSite_FileAsso.xlsx')   //changed for MGT
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/Breed/CokrSpnilChkbx')
WebUI.delay(3)
