...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC35_Canine_StudyMGT-StudyType_StudyPart_Breed_FileFormat.xlsx')   //changed for MGT
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/Breed/Other_Chkbx')
