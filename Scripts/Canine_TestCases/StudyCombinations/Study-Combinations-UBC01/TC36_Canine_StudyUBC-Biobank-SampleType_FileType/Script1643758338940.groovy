...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC36_Canine_StudyUBC-Biobank-SampleType_FileType.xlsx')   //changed for MGT
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Biobank/NotApplicable_Chkbx'), 30)  //changed for MGT

WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/Biobank/NotApplicable_Chkbx'), 5)  //changed for MGT

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('Object Repository/Canine/Filter/Biobank/NotApplicable_Chkbx') //changed for MGT
