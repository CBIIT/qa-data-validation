 ...
 */
WebUI.closeBrowser()
//Study COTC007B, Study Type in (Clinical Trial) and StageOfDisease in (III) and Response To Treatment in (Complete Response, Partial Response) and Sex in (Male)

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC09_Canine_StudyCOTC007B-StudyType_StgOfDis_RespToTreat_Sex.xlsx')
