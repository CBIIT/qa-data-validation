 ...
 */
WebUI.closeBrowser()
//Study COTC007B, Breed in (Basset Hound, Rottweiler ) and Stage Of Disease in (IVa) and Response To Treatment in (Stable Disease)

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC05_Canine_StudyCOTC007B-Breed_StageOfDisease_RespToTreatm.xlsx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/Breed/BassHnd_Chkbx')

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/Breed/Rottweiler_Chkbx')
