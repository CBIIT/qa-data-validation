 ...
 */
WebUI.closeBrowser()
//Study COTC007B, Study Participant in (Single Study) and Breed in (Golden Retriever) and Response to Treatment in (Partial Response)

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC03_Canine_StudyCOTC007B-StudyPartic_Breed_ResponToTreatm.xlsx')
