 ...
 */
WebUI.closeBrowser()
//Study COTC007B, Breed in (American Staffordshire Terrier, Beagle ) and Diagnosis in (Lymphoma) and Stage Of Disease in (III)

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC04_Canine_StudyCOTC007B-Breed_Diagnosis_StageOfDiseas.xlsx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/Breed/Beagle_Chkbx')
