 ...
 */
WebUI.closeBrowser()
//Study COTC007B, Primary Disease Site (Lymph Node) and Sex (Female) and Neutered Status (No)

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC10_Canine_StudyCOTC007B-PrimDiseaseSite_Sex_NeuterSt.xlsx')
