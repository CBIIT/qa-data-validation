 ...
 */
WebUI.closeBrowser()
//Study COTC007B, Biobank in (Not Applicable) and Breed in (Mixed Breed) and Neutered Status in (Yes)

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC02_Canine_StudyCOTC007B-Biobank_Breed_NeuteredStatus.xlsx')
