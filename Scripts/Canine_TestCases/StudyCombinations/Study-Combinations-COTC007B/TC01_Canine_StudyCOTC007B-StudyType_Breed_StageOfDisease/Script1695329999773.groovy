 ...
 */
WebUI.closeBrowser()
//Study COTC022, Study Type in (Clinical Trial) and Breed in ('Bernese Mountain Dog','Boxer') and Stage Of Disease in (IIIa)

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC01_Canine_StudyCOTC007B-StudyType_Breed_StageOfDisease.xlsx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/Breed/BernMtnDog_Chkbx')
