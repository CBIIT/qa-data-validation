 ...
 */
WebUI.closeBrowser()
//Study COTC022, Diagnosis in (Lymphoma) and Responce To Treatment (Not Determined) and Neutered Status (Yes)

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC08_Canine_StudyCOTC007B-Diagnosis_ResponToTreatm_NeutrSt.xlsx')
