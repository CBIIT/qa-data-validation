 ...
 */
WebUI.closeBrowser()
//Study COTC022, Stage Of Disease (III, IV) and Response to Treatment (Progressive Disease) and Sex (Male)

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC06_Canine_StudyCOTC007B-StageOfDisease_RespTo Treatm_Sex.xlsx')
