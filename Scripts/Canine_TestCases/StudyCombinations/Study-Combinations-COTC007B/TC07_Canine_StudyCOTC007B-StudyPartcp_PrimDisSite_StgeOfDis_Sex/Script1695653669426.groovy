 ...
 */
WebUI.closeBrowser()
//Study COTC007B, Study Participation in (Single Study) and Primary Disease Site in (Lymph Node) and Satge Of Disease (Va) and Sex (Female)

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC07_Canine_StudyCOTC007B-StudyPartcp_PrimDisSite_StgeOfDis_Sex.xlsx')
