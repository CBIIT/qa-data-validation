...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC96_Canine_Study_TCL01_SampleType_TumorCellLine(metastasis-derived).xlsx')   //changed for MGT
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Object Repository/Canine/Filter/SampleType/TumorCellLine(metastasis-derived)_Chbx')
