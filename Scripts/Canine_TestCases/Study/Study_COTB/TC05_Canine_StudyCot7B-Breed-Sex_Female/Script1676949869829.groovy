...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC05_Canine_StudyCot7B-Breed-Sex_Female.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Study/Canine_Filter_Study-COTB_Chkbx'), 10)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Canine/Filter/Breed/Beagle_Chkbx'), 10)
