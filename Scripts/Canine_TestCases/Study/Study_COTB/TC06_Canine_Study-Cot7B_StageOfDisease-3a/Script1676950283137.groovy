...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC06_Canine_Study-Cot7B_StageOfDisease-3a.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/StageOfDisease/3a_Chkbx'), 5)
WebUI.waitForElementClickable(findTestObject('Canine/Filter/StageOfDisease/3a_Chkbx'), 10)
