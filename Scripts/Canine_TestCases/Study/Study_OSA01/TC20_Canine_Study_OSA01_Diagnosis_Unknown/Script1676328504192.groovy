...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC20_Canine_Study_OSA01_Diagnosis_Unknown.xlsx')
...
'Selects the specific check box from \'Diagnosis\' filter.'
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/Diagnosis/Unknown_Chkbx')
