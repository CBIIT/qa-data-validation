...
CustomKeywords.'ctdc.utilities.CDSValidation.runKatalonDataValidation'("C3DC","TC04_C3DC_RowDataValidation_phs002504.xlsx")


CustomKeywords.'ctdc.utilities.CDSValidation.runTestCaseByParticipantID'("CCDI_UCSF_phs002504 participants.xlsx", GlobalVariable.G_Value,"participant_id", GlobalVariable.G_ColumNamesParticipTab, 
	GlobalVariable.G_ExTabnameParticipants,GlobalVariable.G_CypherTabnameParticipants, GlobalVariable.G_QueryParticipantsTab)

CustomKeywords.'ctdc.utilities.CDSValidation.runTestCaseByParticipantID'("CCDI_UCSF_phs002504 diagnoses.xlsx", GlobalVariable.G_Value,"participant_id", GlobalVariable.G_ColumNamesDiagnosisTab ,
	GlobalVariable.G_ExTabnameDiagnosis,GlobalVariable.G_CypherTabnameDiagnosis, GlobalVariable.G_QueryDiagnosisTab)

CustomKeywords.'ctdc.utilities.CDSValidation.runTestCaseByParticipantID'("CCDI_UCSF_phs002504 survivals.xlsx", GlobalVariable.G_Value,"participant_id", GlobalVariable.G_ColumNamesSurvivalTab ,
