...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC15_Canine_Filter_Breed-Chinese.xlsx')
...
WebUI.click( findTestObject('Object Repository/Canine/Filter/Breed/Chinese_Chkbx') )
