...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC11_Canine_Filter_Breed-Boxer.xlsx')
...
WebUI.click( findTestObject('Object Repository/Canine/Filter/Breed/Boxer_Chkbx') )
