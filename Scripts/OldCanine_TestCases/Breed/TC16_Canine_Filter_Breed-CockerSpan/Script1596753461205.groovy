...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC16_Canine_Filter_Breed-CockerSpan.xlsx')
...
WebUI.click( findTestObject('Object Repository/Canine/Filter/Breed/CockerSpan_Chkbx') )
