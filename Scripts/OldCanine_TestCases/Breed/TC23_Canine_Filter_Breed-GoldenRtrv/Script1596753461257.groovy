...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC23_Canine_Filter_Breed-GoldenRtrv.xlsx')
...
WebUI.click( findTestObject('Object Repository/Canine/Filter/Breed/GoldenRetr_Chkbx') )
