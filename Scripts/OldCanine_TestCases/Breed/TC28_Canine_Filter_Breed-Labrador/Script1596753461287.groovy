...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC28_Canine_Filter_Breed-Labrador.xlsx')
...
WebUI.click( findTestObject('Object Repository/Canine/Filter/Breed/Labrador_Chkbx')  )
