...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC35_Canine_Filter_Breed-Samoyed.xlsx')
...
WebUI.click( findTestObject('Object Repository/Canine/Filter/Breed/Samoyed_Chkbx') )
