...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC13_Canine_Filter_Breed-CavalierKing.xlsx')
...
WebUI.click( findTestObject('Object Repository/Canine/Filter/Breed/CavalierKing_Chkbx') )
