...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC34_Canine_Filter_Breed-SaintBnd.xlsx')
...
WebUI.click( findTestObject('Object Repository/Canine/Filter/Breed/SaintBnd_Chkbx') )
