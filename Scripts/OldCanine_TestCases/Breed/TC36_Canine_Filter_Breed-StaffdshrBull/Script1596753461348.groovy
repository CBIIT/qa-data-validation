...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC36_Canine_Filter_Breed-StaffdshrBull.xlsx')
...
WebUI.click( findTestObject('Object Repository/Canine/Filter/Breed/StaffdshrBull_Chkbx') )
