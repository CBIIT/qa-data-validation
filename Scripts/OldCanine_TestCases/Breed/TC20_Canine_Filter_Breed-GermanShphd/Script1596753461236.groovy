...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC20_Canine_Filter_Breed-GermanShphd.xlsx')
...
WebUI.click(  findTestObject('Object Repository/Canine/Filter/Breed/GermanShphd_Chkbx') )
