...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC19_Canine_Filter_Breed-Flat.xlsx')
...
WebUI.click( findTestObject('Object Repository/Canine/Filter/Breed/Flat_Chkbx')  )
