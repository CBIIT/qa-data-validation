...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC17_Canine_Filter_Breed-Doberman.xlsx')
...
WebUI.click( findTestObject('Object Repository/Canine/Filter/Breed/Doberman_Chkbx')  )
