...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC11_Canine_Filter_Diagnosis-MaligLymph.xlsx')
...
WebUI.click(  findTestObject('Canine/Filter/Diagnosis/Melanoma_Chkbx')  )
