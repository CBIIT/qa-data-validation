...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC12_Canine_Filter_Diagnosis-MaligMetastatic.xlsx')
...
WebUI.click(  findTestObject('Canine/Filter/Diagnosis/TCellLymphoma_Chkbx')  )
