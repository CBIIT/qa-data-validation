...
//	 */
//	@Keyword
//	public static void ReadStudiesTabTbl(String statVal1, String tbl1, String hdr1, String nxtb1, String webSheetName) throws IOException {
//
//		String switchCanine
//		String switchTrials
//		String switchBento
...
//		GlobalVariable.G_cannine_studiesTbl=tbl_bdy  //correct his variables name typo and also rename it to G_commons_casetblbdy
//		System.out.println("This is the value of table body :"+GlobalVariable.G_cannine_studiesTbl)
//
...
//
//		WebElement TableBdy =driver.findElement(By.xpath(GlobalVariable.G_cannine_studiesTbl))
...
//			while(counter <= 2)
//			{
//				wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(GlobalVariable.G_cannine_StudiesTblBdy)));   //the name is misleading but it is only a placeholder for all the applications
//				scrolltoViewjs(driver.findElement(By.xpath(GlobalVariable.G_cannine_StudiesTblBdy)))
//				TableBdy =driver.findElement(By.xpath(GlobalVariable.G_cannine_StudiesTblBdy))
...
//									}
//
//								}else if((tbl_main).equals("//*[@id='table_studies']")){
